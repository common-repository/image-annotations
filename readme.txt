...
* Added the ability to respond to the annotation
* By clicking on the area of the transition to annotation
* Many style changes.
* Major bug fixes.

* Добавлена возможность отвечать на оставленные аннотации
* При клике на выделение происходит переход к аннотации
* Изменены стили
* Исправлены ошибки
